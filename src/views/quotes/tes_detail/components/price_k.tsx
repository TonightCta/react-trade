...
const option: any = {
    ...
    tooltip: {
        ...
        formatter: function (param: any) {
            param = param[0];
            return [
                "<div style='display:flex;justify-content:space-between;'><p style='width:60px;text-align:left;'>时间:</p>" + `<p>${param.name}</p></div>`,
                "<div style='display:flex;justify-content:space-between;'><p style='width:60px;text-align:left;'>开:</p>" + `<p>${param.data[0]}</p></div>`,
                "<div style='display:flex;justify-content:space-between;'><p style='width:60px;text-align:left;'>高:</p>" + `<p>${Number(param.data[3]).toFixed(2)}</p></div>`,
                "<div style='display:flex;justify-content:space-between;'><p style='width:60px;text-align:left;'>收:</p>" + `<p>${Number(param.data[1]).toFixed(2)}</p></div>`,
                "<div style='display:flex;justify-content:space-between;'><p style='width:60px;text-align:left;'>低:</p>" + `<p>${Number(param.data[2]).toFixed(2)}</p></div>`,
            ].join('');
        }
    },
    yAxis: [
...
const TesPriceK = (): ReactElement<ReactNode> => {
