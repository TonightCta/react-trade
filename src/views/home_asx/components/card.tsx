...
const HomeCard = (props: { history: any }): ReactElement<ReactNode> => {
    ...
    const list: Array<CardMsg> = [
        ...
        },
        {
            ...
            icon: require('../../../assets/images/home_asx/home_icon_2.png'),
            url: '/quotes',
            outSide: false,
            inner: false,
        },
        {
            ...
            icon: require('../../../assets/images/home_asx/home_icon_3.png'),
        ...
        {
            title: t('public.set'),
            icon: require('../../../assets/images/home_asx/home_icon_4.png'),
            url: '/setting',
            outSide: false,
            inner: false,
        }
