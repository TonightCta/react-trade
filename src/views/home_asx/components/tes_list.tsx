    ...
    return (
        <div className="home-tes-list">
            ...
            <p className="list-title">
                <img src={require('../../../assets/images/home_asx/text_before.png')} alt="" />
                <span>{t('public.up_list').toUpperCase()}</span>
            </p>
                                        ...
                                        <div className="list-public">
                                            ...
                                            <div className="coin-msg-hour">
                                                ...
                                                <div className="coin-msg">
                                                    ...
                                                    <p>24H vol&nbsp;{Number(el.yesterday_volume / 1000).toFixed(2)}K&nbsp;</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="list-public">
