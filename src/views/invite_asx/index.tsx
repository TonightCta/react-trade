...
const InviteIndexASX = (): ReactElement<ReactNode> => {
    ...
    return (
        <div className={`invite-index-asx`}>
            ...
            <div className="invite-box">
                ...
                <div className="p-12">
                    <div className="invite-box-1">
                        <div className="success-get">
                            <p className="get-title">
                                <span>Successfully recommended a friend</span>
                                <img src={require('../../assets/images/home_asx/title_before.png')} alt="" />
                            </p>
                            <img className="title-end" src={require('../../assets/images/home_asx/title_end.png')} alt="" />
                            <div className="bottom-remark">
                                <p>After recharging, you will get：</p>
                                <p className="need-bg">10%~60%</p>
                                <p className="remark-normal">Invitation commission</p>
                                <p className="remark-normal">Enjoy multi-level commission return</p>
                            </div>
                        </div>
                        <div className="box-1-bottom">
                            ...
                            <div className="share-link">
                                <div className="link-code link-public" onClick={() => {
                                    ...
                                    <img src={require('../../assets/images/home_asx/copy_code.png')} alt="" />
                                    <p>
                                        {/* Copy Code */}
                                        {t('invite.copy_code')}
                                    </p>
                                ...
                                <div className="link-url link-public" onClick={() => {
                                    ...
                                    <img src={require('../../assets/images/home_asx/copy_link.png')} alt="" />
                                    <p>
                                        {/* Copy Link */}
                                        {t('invite.copy_link')}
                                    </p>
                                </div>
                                <div className="link-share link-public">
                                    <Popover
                                        content={<QrImg />}
                                        trigger='click'
                                        placement='top'
                                    >
                                        <p className="share-qr">
                                            <img src={require('../../assets/images/home_asx/share_qr.png')} alt="" />
                                        </p>
                                    </Popover>
                                    <p>QR code</p>
                                </div>
                    ...
                    <div className="invite-box-2">
                        <p className="ranking-mine">
                            ...
                            <img src={require('../../assets/images/home_asx/rank_before.png')} alt="" />
                            <span>{t('invite.rank_remark')}</span>
                        </p>
                                ...
                                <li>
                                    {rankList.length > 1 ? <>
                                        <div className="three-avatar">
                                            ...
                                            <img className="crown" src={require('../../assets/images/home_asx/two.png')} alt="" />
                                        </div>
                                ...
                                <li>
                                    {rankList.length > 0 ? <>
                                        <div className="three-avatar">
                                            ...
                                            <img className="crown" src={require('../../assets/images/home_asx/one.png')} alt="" />
                                        </div>
                                ...
                                <li>
                                    {rankList.length > 2 ? <>
                                        <div className="three-avatar">
                                            ...
                                            <img className="crown" src={require('../../assets/images/home_asx/three.png')} alt="" />
                                        </div>
                ...
                <div className="invite-btn">
                    ...
                    >
                        <div className="invite-qr">
                            <img src={require('../../assets/images/home_asx/other_qr.png')} alt="" />
                        </div>
                    </Popover>
