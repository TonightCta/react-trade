...
const shareList = [
    ...
    },
    {
        ...
        name: 'Telegram',
        url: `https://t.me/share/url?url=${url}&text=${encodeURIComponent('YD')}`
    },
    {
        icon: require('../../assets/images/reddit_icon.png'),
        name: 'Reddit',
        url: `http://www.reddit.com/submit?url=${url}&title=${encodeURIComponent('YD')}`
    },
    {
        icon: require('../../assets/images/whats_icon.png'),
        name: 'Whatsapp',
        url: `https://web.whatsapp.com/send?text=${encodeURIComponent('YD')}&url=${url}`
    },
    {
